...
public class MysqlManage {
    ...
    private static MysqlManage mysqlManage = null;


    public static MysqlManage getInstance() throws ClassNotFoundException, SQLException, ParserConfigurationException, SAXException, IOException {
        if(mysqlManage == null){
            synchronized(Service.class){
                if (mysqlManage == null) {
                    mysqlManage = new MysqlManage();
                }
            }
        }
        return mysqlManage;
